...
# ─────────────────────────────────────────────
    ...
    with col2:
        ...
        fmt = st.radio("Output Format", ["PDF (simulated)", "Excel", "Text Summary"])
...
- **Automation rate achieved:** {100 - (fdf["Status"] == "Pending").sum() / len(fdf) * 100:.1f}%
...
"""
        ...
        st.download_button("⬇️ Download Report (Markdown)", report_text.encode(), "agc_report.md", "text/markdown")
